...
import com.bizhil.springbootinit.common.*;
...
import com.bizhil.springbootinit.model.dto.user.UserAddRequest;
import com.bizhil.springbootinit.model.dto.user.UserLoginRequest;
import com.bizhil.springbootinit.model.dto.user.UserQueryRequest;
import com.bizhil.springbootinit.model.dto.user.UserRegisterRequest;
import com.bizhil.springbootinit.model.dto.user.UserUpdateMyRequest;
import com.bizhil.springbootinit.model.dto.user.UserUpdateRequest;
...
import static com.bizhil.springbootinit.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        user.setUserAvatar("http://47.115.230.253:8101/api/images/" + randomAvatar); // 设置头像路径
        String userAvatar = user.getUserAvatar();
        long result = userService.userRegister(userAccount, userName, userPassword, checkPassword, userAvatar);
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        // 记录登录成功日志
        log.info("User logged in successfully: userAccount={}", userAccount);
